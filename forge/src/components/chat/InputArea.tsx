      ...
      <div className="flex items-end gap-2 max-w-4xl mx-auto">
        <div className="flex-1 relative">
          <textarea
            ...
            rows={1}
            className="w-full bg-surface2 border border-border rounded-lg px-4 py-3 pr-10 text-sm text-gray-200 outline-none focus:border-accent resize-none min-h-[48px] max-h-[200px]"
          />
